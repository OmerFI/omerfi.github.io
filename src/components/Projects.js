    ...
    <div className="projects" id="projects">
      ...
      <div className="content">
        <Project
          ...
          projectTechStack="JavaScript, React, Django, DRF"
        ...
        <Project
          ...
          projectTechStack="JavaScript, Flask, Docker, Nginx"
        ...
        <Project
          ...
          projectDescription="An extension that allows you to quickly change your Google Search language preferences such as pages in the specified language and web interface language."
